...
\begin{frame}{The IV Solution}
  \begin{adjustbox}{width = 0.9\textwidth, center}
    \begin{tikzpicture}
      ...
      \path[thick, shorten >=4pt, shorten <=4pt] (estimands) edge[bend left= 40] node[below, el, yshift=-4pt] {Identifcation} (parameters);
...
\begin{frame}{Regression ``Exogeneity''}
  \begin{adjustbox}{width = 0.6\textwidth, center}
    \begin{tikzpicture}
      \node[state] (1) at (0,0) {$D$};
      \node[state] (2) at (2,0) {$Y$};
      \node[state, ruby] (3) at (1,1.5) {$\epsilon$};
    
      \path[violet-red, thick] (1) edge node[above, el] {$\violetRed{\beta}$} (2);
      \path[ruby, thick] (3) edge (2);
    \end{tikzpicture}
  \end{adjustbox}
\end{frame}
...
\begin{frame}{The IV Solution}
  \begin{adjustbox}{width = 0.7\textwidth, center}
    \begin{tikzpicture}
      ...
      \node[state] (2) at (2,0) {$Y$};
      \node[state, ruby] (3) at (1,1.5) {$\epsilon$};
      \node[state, kelly] (4) at (-2,0) {$Z$};
    
      \path[violet-red, thick] (1) edge node[above, el] {$\violetRed{\beta}$} (2);
      \path[ruby, thick] (3) edge (2);
      \path[ruby, thick] (3) edge (1);
      \path[kelly, thick] (4) edge (1);
    \end{tikzpicture}
  \end{adjustbox}
\end{frame}
